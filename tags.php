...
$tag_name = $description = $latitude = $longitude = $id = '';
                ...
                <form form action="tags.php?submit&edit=<?php echo $_GET["edit"]?>" enctype="multipart/form-data" class="form-horizontal" id="edit_tag_form" method="POST">
                    ...
                    <div class="row-fluid">
                        <div class="span5">
							...
							<input type="text" id="url" name="url" value="<?php echo $url ?>" class="input-block-level" pattern="https?://.*">

                            <label for="facebook"><br>Facebook</label>
                            <input type="text" id="facebook" name="facebook" value="<?php echo $facebook ?>" class="input-block-level" pattern="https?://.*">

                            <label for="twitter"><br>Twitter</label>
                            <input type="text" id="twitter" name="twitter" value="<?php echo $twitter ?>" class="input-block-level" pattern="https?://.*">
